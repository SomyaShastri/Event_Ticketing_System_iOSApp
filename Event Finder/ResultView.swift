...
func eventsCall(eveid: String, completion: @escaping ([String:String]) -> Void) {
    ...
    let apiUrl: String = "http://127.0.0.1:8081/event_details?eveid=" + eveid;
    print(apiUrl)
...
func artistCall(eventData: [String:String], completion: @escaping ([Artist]) -> Void) {
    ...
    print(categ)
    if (categ.contains("Music") && artistname != "") {
        //let apiUrl2 = "https://eco-byte-377504.wl.r.appspot.com/spotify_details?artistName=" +
        let apiUrl2 = "http://127.0.0.1:8081/spotify_details?artistName=" + artistname.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!
        print(apiUrl2);
...
func venueCall(locName: String, completion: @escaping ([String:String]) -> Void) {
    ...
    let apiUrl3 = "http://127.0.0.1:8081/venue_details?keyword=" + locName.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!;
